                ...
                <div class="container">
                    <div class="pagetitle d-flex justify-content-between align-items-center">
                        ...
                        <div class="sticky-pagination" style="display: flex; flex-direction: row; align-items: center;">
                            <a href="{{ route('downloadAoSoc') }}" class="btn btn-success btn-sm" title="Download Data" style="font-size: 18px; padding: 10px 10px; margin-bottom: 10px;">
                                <i class="fa fa-download" aria-hidden="true"></i> Download
                            </a>
                        </div>
                    </div>
                    <div class="d-flex flex-wrap mb-4">
                        <a class="nav-link active" href="{{ url('/admission/admissionOfficerSocLayout') }}" style="text-decoration: none;">
                        ...
                        <a class="nav-link collapsed" href="{{url('/admission/admissionOfficerSidLayout') }}" style="margin-left: 20px; text-decoration: none;">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            @php
                                            $students = \App\Models\Student::where('SOC', 1)->orderByDesc('TOTAL')->get();
                                            $rank = 1;
                                            @endphp
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <a href="{{ route('admissionOfficerEditSoc', ['INDEX_NO' => str_pad($student->INDEX_NO, 12, '0', STR_PAD_LEFT)]) }}" title="Admission Officer Edit Student">
