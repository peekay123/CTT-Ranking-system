                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8" style="top: 80px">
                        <div class="pagetitle d-flex justify-content-between align-items-center" >
                            <h1>Add Admission Officer</h1>
                            <a class="nav-link collapsed d-inline-block" href="{{ route('aoLayout') }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('admissionOfficer') }}" method="post" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    <label>Name</label></br>
                                    <input type="text" name="name" id="name" class="form-control" style="font-size: 16px"></br>
                                    <label>CID</label></br>
                                    <input type="number" name="cid" id="cid" class="form-control" style="font-size: 16px"></br>
                                    <label>Email</label></br>
                                    <input type="email" name="email" id="email" class="form-control" style="font-size: 16px"></br>
                                    <label>Phone</label></br>
                                    <input type="number" name="phone" id="phone" class="form-control" style="font-size: 16px"></br>
                                    <label>Password</label></br>
                                    <input type="text" name="password" id="password" class="form-control" style="font-size: 16px"></br>
                                    <button type="submit" style="background-color: #23242A;color:white; font-size:16px; border-radius:4px;">Upload</button>
                                </form>
                            </div>
                        </div>
                    </div>
