                    ...
                    <div class="col-lg-8" style="top: 80px">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('updateDate', ['id' => $apply->id]) }}" style="margin-top: 20px;" accept-charset="UTF-8">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-group">
                                        <label for="applyDate">applyDate</label>
                                        <input type="date" name="applyDate" id="applyDate" value="{{ $apply->applyDate }}" class="form-control" required style="font-size:14px;">
                                    </div>
