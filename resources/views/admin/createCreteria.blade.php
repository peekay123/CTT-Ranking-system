            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8" style="top: 80px">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('createCreteria') }}" style="margin-top: 20px;" enctype="multipart/form-data">
                                    {!! csrf_field() !!}
                                    <label for="image" style="font-size: 16px" >Upload Image:</label></br>
                                    <input type="file" name="image" id="image" class="form-control" accept="image/*" style="font-size: 16px"></br>
                                    <label>Title</label></br>
                                    <input type="text" name="title" id="title" class="form-control" style="font-size: 16px"></br>
                                    <label>Description</label></br>
                                    <input type="text" name="description" id="description" class="form-control" style="font-size: 16px"></br>
