            ...
            <div class="home-content">
                <div class="container">
                    <div class="pagetitle d-flex justify-content-between align-items-center">
                        <h1>All Admission Officers</h1>
                            <a href="{{ route('createAo') }}" class="btn btn-lg btn-dark" style="font-size: 18px; padding: 10px 20px; " title="Add New Student">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                                        ...
                                                        @foreach($users as $user)
                                                            @if($user->role == 'ao')
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <a href="{{ route('viewAdmissionOfficer', ['cid' => $user->cid]) }}" title="View Admission officer">
                                                                                <button class="btn btn-sm mr-2" style="background-color:#15B83F; font-size: 14px; color: white;">
                                                                                    <i class="fa fa-eye" aria-hidden="true"></i> View
                                                                                </button>
                                                                            </a>

                                                                            <a href="{{ route('editAdmissionOfficer', ['cid' => $user->cid]) }}" title="Edit Admission Officer">
                                                                                <button class="btn btn-sm mr-2" style="background-color:#FFBF00;font-size: 14px; color:white">
                                                                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                                                </button>
                                                                            </a>

                                                                            <form method="POST" action="{{ route('deleteAdmissionOfficer', ['cid' => $user->cid]) }}" accept-charset="UTF-8" style="display:inline">
                                                                                @method('DELETE')
                                                                                @csrf
                                            ...
                                            @else
                                                <p>No admission officers found.</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
