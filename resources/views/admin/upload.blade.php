     ...
     <section class="section dashboard">
        <div class="home-content">
            ...
            <div class="wrapper">
                <div class="container">
                    <h1>Upload a file</h1>
                    <form class = "form" method="POST" enctype="multipart/form-data" action="{{route('import-data')}}">
                        @csrf
                        <div class="upload-container">
                            ...
                            <div class="icons fa-4x">
                                ...
                                <input type="file" name="file" id="file-upload" style="display: none;" accept=".xml, .xls">
                                <p>Drag and drop files here, or
                                <a href="#" id="file-browser">browse</a> your computer.</p>
                                <p id="file-name-display"></p>
                            </div>
                            </div>
                    <button type="submit" class="btn btn-primary btn-outline-light" style="font-size: 18px; padding: 10px 20px; " name="uploadbutton">Upload file</button>
                </form>
                </div>
                </div>
            </div>
