                ...
                <div class="container">
                    <div class="pagetitle d-flex justify-content-between align-items-center">
                        <h1>Applied Students</h1>
                            <a href="{{ route('createStudent') }}" class="btn btn-lg btn-dark" style="font-size: 18px; padding: 10px 20px; " title="Add New Student">
                                <i class="fa fa-plus" aria-hidden="true"></i> Add New
                            </a>
                    </div>

                    <div class="search-bar d-flex justify-content-between align-items-center mb-3">
                        <form class="search-form d-flex align-items-center flex-grow-1" style="font-size: 18px; border-radius: 4px;" method="GET" action="{{ route('searchStudentByIndex') }}">
                                                    ...
                                                    <tbody>
                                                        @foreach($students as $student)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="{{ route('viewStudent', ['INDEX_NO' => str_pad($student->INDEX_NO, 12, '0', STR_PAD_LEFT)]) }}" title="View Student">
                                                                            <button class="btn btn-sm mr-2" style="background-color:#15B83F; font-size: 14px; color: white;">
                                                                                <i class="fa fa-eye" aria-hidden="true"></i> View
                                                                            </button>
                                                                        </a>

                                                                        <a href="{{ route('editStudent', ['INDEX_NO' => str_pad($student->INDEX_NO, 12, '0', STR_PAD_LEFT)]) }}" title="Edit Student">
