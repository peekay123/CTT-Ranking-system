                ...
                <div class="container">
                    <div class="pagetitle d-flex justify-content-between align-items-center">
                        <h1>Application Deadline</h1>
                            <a href="{{ route('createDate') }}" class="btn btn-lg btn-dark" style="font-size: 18px; padding: 10px 20px; " title="Add New Student">
                                <i class="fa fa-plus" aria-hidden="true"></i> Add Date
                            </a>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            @php
                                                $applys = \App\Models\ApplyDate::all();
                                            @endphp
                                            @if($applys->isNotEmpty())
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>ID</th>
                                                    ...
                                                    <tbody>
                                                        @foreach($applys as $apply)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="{{ route('editDate', ['id' => $apply->id]) }}" title="Edit apply">
                                                                            <button class="btn btn-sm mr-2" style="background-color:#FFBF00;font-size: 14px; color:white">
                                                                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                                            </button>
                                                                        </a>

                                                                        <form method="POST" action="{{ route('deleteDate', ['id' => $apply->id]) }}" accept-charset="UTF-8" style="display:inline">
                                                                            @method('DELETE')
                                                                            @csrf
                                                                            <button type="submit" class="btn btn-sm" title="Delete apply" onclick="return confirm('Confirm delete?')" style="background-color:#FF0000;font-size: 14px;color:white">
