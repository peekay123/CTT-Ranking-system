                ...
                <div class="container">
                    <div class="two-button" >
                        <div class="d-flex flex-wrap mb-4">
                            <a class="nav-link active" href="{{ url('/admin/socLayout') }}"></a>
                                <button type="submit" style="background-color: #23242A;color:white; font-size:16px; border-radius:4px;margin-top: 20px">Total Students</button>
                            </a>
                            <a class="nav-link collapsed" href="{{ url('/admin/sidLayout') }}" style="margin-left: 20px">
                                <button type="submit" style="background-color:white; font-size:16px; border-color:#23242A; border-radius:4px;margin-top: 20px">Apply Students</button>
                            </a>
                        </div>
                    </div>

                    <div class="search-bar">
                        <form class="search-form d-flex align-items-center" style="margin-bottom: 20px; font-size:16px; border-radius:4px " method="GET" action="{{ route('searchSocByIndex') }}">
                            <input type="text" name="query" placeholder="Search" title="Enter INDEX_NO">
                                            ...
                                            @if(isset($students) && $students->isNotEmpty())
                                                ...
                                                @if($sortedStudents->isNotEmpty())
                                                    ...
                                                    <div class="sticky-pagination" style="display: flex; flex-direction: row; align-items: center;">
                                                        <a href="{{ route('downloadSoc') }}" class="btn btn-success btn-sm" title="Download Data" style="font-size: 18px; padding: 10px 20px; margin-bottom: 10px;">
