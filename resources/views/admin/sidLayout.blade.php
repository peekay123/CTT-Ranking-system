                ...
                <div class="container">
                    ...
                    <div class="pagetitle d-flex justify-content-between align-items-center">
                        <div class="d-flex flex-wrap mb-4">
                            <a class="nav-link collapsed" href="{{ url('/admin/socLayout') }}" style="text-decoration: none; display: flex; align-items: stretch;">
                                <div style="background-color: white; border: 1px solid #23242A; font-size: 16px; border-radius: 4px; margin-top: 20px; padding: 8px 12px; display: flex; align-items: center;">School of Computing</div>
                            </a>
                            <a class="nav-link active" href="{{ url('/admin/sidLayout') }}" style="margin-left: 20px; text-decoration: none; display: flex; align-items: stretch;">
                                <div style="background-color: #23242A; color: white; font-size: 16px; border-radius: 4px; margin-top: 20px; padding: 8px 12px; display: flex; align-items: center;">School of Interactive Design & Development</div>
                            </a>
                        </div>
                        <div class="sticky-pagination" style="display: flex; flex-direction: row; align-items: center;">
                            <a href="{{ route('downloadSidd') }}" class="btn btn-success btn-sm" title="Download Data" style="font-size: 18px; padding: 10px 10px; margin-bottom: 10px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    <div class="btn-group">
                                                                        <a href="{{ route('viewSid', ['INDEX_NO' => str_pad($student->INDEX_NO, 12, '0', STR_PAD_LEFT)]) }}" title="View Student">
                                                                            <button class="btn btn-sm mr-2 " style="background-color:#15B83F; font-size: 14px; color: white;">
                                                                                <i class="fa fa-eye" aria-hidden="true"></i> View
                                                                            </button>
                                                                        </a>

                                                                        <a href="{{ route('editSid', ['INDEX_NO' => str_pad($student->INDEX_NO, 12, '0', STR_PAD_LEFT)]) }}" title="Edit Student">
